...
const braveAppModalStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'app_modal_strings.grdp'))
const chromiumAutofillAssistantStringsPartPath = path.resolve(path.join(srcDir, 'components', 'autofill_assistant_strings.grdp'))
const braveAutofillAssistantStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'autofill_assistant_strings.grdp'))
const chromiumAutofillPaymentsStringsPartPath = path.resolve(path.join(srcDir, 'components', 'autofill_payments_strings.grdp'))
const braveAutofillPaymentsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'autofill_payments_strings.grdp'))
const chromiumAutofillStringsPartPath = path.resolve(path.join(srcDir, 'components', 'autofill_strings.grdp'))
const braveAutofillStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'autofill_strings.grdp'))
const chromiumBookmarkBarStringsPartPath = path.resolve(path.join(srcDir, 'components', 'bookmark_bar_strings.grdp'))
const braveBookmarkBarStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'bookmark_bar_strings.grdp'))
const chromiumBookmarkComponentStringsPartPath = path.resolve(path.join(srcDir, 'components', 'bookmark_component_strings.grdp'))
const braveBookmarkComponentStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'bookmark_component_strings.grdp'))
const chromiumBrowsingDataStringsPartPath = path.resolve(path.join(srcDir, 'components', 'browsing_data_strings.grdp'))
const braveBrowsingDataStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'browsing_data_strings.grdp'))
...
const braveComponentsSettingsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'components_settings_strings.grdp'))
const chromiumCrashStringsPartPath = path.resolve(path.join(srcDir, 'components', 'crash_strings.grdp'))
const braveCrashStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'crash_strings.grdp'))
const chromiumDialogStringsPartPath = path.resolve(path.join(srcDir, 'components', 'dialog_strings.grdp'))
const braveDialogStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'dialog_strings.grdp'))
const chromiumDomDistillerStringsPartPath = path.resolve(path.join(srcDir, 'components', 'dom_distiller_strings.grdp'))
const braveDomDistillerStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'dom_distiller_strings.grdp'))
const chromiumErrorPageStringsPartPath = path.resolve(path.join(srcDir, 'components', 'error_page_strings.grdp'))
const braveErrorPageStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'error_page_strings.grdp'))
const chromiumFindInPageStringsPartPath = path.resolve(path.join(srcDir, 'components', 'find_in_page_strings.grdp'))
const braveFindInPageStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'find_in_page_strings.grdp'))
const chromiumFlagsStringsPartPath = path.resolve(path.join(srcDir, 'components', 'flags_strings.grdp'))
const braveFlagsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'flags_strings.grdp'))
const chromiumHistoryStringsPartPath = path.resolve(path.join(srcDir, 'components', 'history_strings.grdp'))
const braveHistoryStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'history_strings.grdp'))
const chromiumLoginDialogStringsPartPath = path.resolve(path.join(srcDir, 'components', 'login_dialog_strings.grdp'))
const braveLoginDialogStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'login_dialog_strings.grdp'))
...
const braveMediaMessageCenterStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'media_message_center_strings.grdp'))
const chromiumNewOrSadTabStringsPartPath = path.resolve(path.join(srcDir, 'components', 'new_or_sad_tab_strings.grdp'))
const braveNewOrSadTabStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'new_or_sad_tab_strings.grdp'))
const chromiumNtpSnippetsStringsPartPath = path.resolve(path.join(srcDir, 'components', 'ntp_snippets_strings.grdp'))
const braveNtpSnippetsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'ntp_snippets_strings.grdp'))
const chromiumOmniboxStringsPartPath = path.resolve(path.join(srcDir, 'components', 'omnibox_strings.grdp'))
const braveOmniboxStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'omnibox_strings.grdp'))
const chromiumPageInfoStringsPartPath = path.resolve(path.join(srcDir, 'components', 'page_info_strings.grdp'))
const bravePageInfoStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'page_info_strings.grdp'))
const chromiumPasswordManagerStringsPartPath = path.resolve(path.join(srcDir, 'components', 'password_manager_strings.grdp'))
const bravePasswordManagerStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'password_manager_strings.grdp'))
const chromiumPaymentsStringsPartPath = path.resolve(path.join(srcDir, 'components', 'payments_strings.grdp'))
const bravePaymentsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'payments_strings.grdp'))
const chromiumPdfStringsPartPath = path.resolve(path.join(srcDir, 'components', 'pdf_strings.grdp'))
const bravePdfStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'pdf_strings.grdp'))
const chromiumPolicyStringsPartPath = path.resolve(path.join(srcDir, 'components', 'policy_strings.grdp'))
const bravePolicyStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'policy_strings.grdp'))
const chromiumPrintMediaStringsPartPath = path.resolve(path.join(srcDir, 'components', 'print_media_strings.grdp'))
const bravePrintMediaStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'print_media_strings.grdp'))
const chromiumPrintingComponentStringsPartPath = path.resolve(path.join(srcDir, 'components', 'printing_component_strings.grdp'))
const bravePrintingComponentStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'printing_component_strings.grdp'))
const chromiumResetPasswordStringsPartPath = path.resolve(path.join(srcDir, 'components', 'reset_password_strings.grdp'))
const braveResetPasswordStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'reset_password_strings.grdp'))
const chromiumSafeBrowsingStringsPartPath = path.resolve(path.join(srcDir, 'components', 'safe_browsing_strings.grdp'))
const braveSafeBrowsingStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'safe_browsing_strings.grdp'))
...
const braveSecurityInterstitialsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'security_interstitials_strings.grdp'))
const chromiumSecurityStateStringsPartPath = path.resolve(path.join(srcDir, 'components', 'security_state_strings.grdp'))
const braveSecurityStateStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'security_state_strings.grdp'))
const chromiumSslErrorsStringsPartPath = path.resolve(path.join(srcDir, 'components', 'ssl_errors_strings.grdp'))
const braveSslErrorsStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'ssl_errors_strings.grdp'))
const chromiumSyncUiStringsPartPath = path.resolve(path.join(srcDir, 'components', 'sync_ui_strings.grdp'))
const braveSyncUiStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'sync_ui_strings.grdp'))
const chromiumTranslateStringsPartPath = path.resolve(path.join(srcDir, 'components', 'translate_strings.grdp'))
const braveTranslateStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'translate_strings.grdp'))
const chromiumUndoStringsPartPath = path.resolve(path.join(srcDir, 'components', 'undo_strings.grdp'))
const braveUndoStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'undo_strings.grdp'))
const chromiumVersionUiStringsPartPath = path.resolve(path.join(srcDir, 'components', 'version_ui_strings.grdp'))
const braveVersionUiStringsPartPath = path.resolve(path.join(srcDir, 'brave', 'app', 'version_ui_strings.grdp'))
