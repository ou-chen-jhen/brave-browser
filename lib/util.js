...
const util = {
  ...
  updateBranding: () => {
    ...
    // chrome/app/generated_resources.grd and all of its parts
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'generated_resources.grd')] = path.join(config.srcDir, 'chrome', 'app', 'generated_resources.grd')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'bookmarks_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'bookmarks_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'app_management_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'app_management_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'media_router_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'media_router_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'global_media_controls_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'global_media_controls_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'profiles_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'profiles_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'os_settings_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'os_settings_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'settings_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'settings_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'extensions_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'extensions_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'welcome_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'welcome_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'printing_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'printing_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'vr_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'vr_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'xr_consent_ui_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'xr_consent_ui_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'supervised_user_error_page_strings.grdp')] = path.join(config.srcDir, 'chrome', 'app', 'supervised_user_error_page_strings.grdp')
    // components/components_strings.grd and all of its parts
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'components_strings.grd')] = path.join(config.srcDir, 'components', 'components_strings.grd')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'app_modal_strings.grdp')] = path.join(config.srcDir, 'components', 'app_modal_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'autofill_assistant_strings.grdp')] = path.join(config.srcDir, 'components', 'autofill_assistant_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'autofill_payments_strings.grdp')] = path.join(config.srcDir, 'components', 'autofill_payments_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'autofill_strings.grdp')] = path.join(config.srcDir, 'components', 'autofill_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'bookmark_bar_strings.grdp')] = path.join(config.srcDir, 'components', 'bookmark_bar_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'bookmark_component_strings.grdp')] = path.join(config.srcDir, 'components', 'bookmark_component_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'browsing_data_strings.grdp')] = path.join(config.srcDir, 'components', 'browsing_data_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'components_settings_strings.grdp')] = path.join(config.srcDir, 'components', 'components_settings_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'crash_strings.grdp')] = path.join(config.srcDir, 'components', 'crash_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'dialog_strings.grdp')] = path.join(config.srcDir, 'components', 'dialog_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'dom_distiller_strings.grdp')] = path.join(config.srcDir, 'components', 'dom_distiller_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'error_page_strings.grdp')] = path.join(config.srcDir, 'components', 'error_page_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'find_in_page_strings.grdp')] = path.join(config.srcDir, 'components', 'find_in_page_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'flags_strings.grdp')] = path.join(config.srcDir, 'components', 'flags_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'history_strings.grdp')] = path.join(config.srcDir, 'components', 'history_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'login_dialog_strings.grdp')] = path.join(config.srcDir, 'components', 'login_dialog_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'media_message_center_strings.grdp')] = path.join(config.srcDir, 'components', 'media_message_center_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'new_or_sad_tab_strings.grdp')] = path.join(config.srcDir, 'components', 'new_or_sad_tab_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'ntp_snippets_strings.grdp')] = path.join(config.srcDir, 'components', 'ntp_snippets_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'omnibox_strings.grdp')] = path.join(config.srcDir, 'components', 'omnibox_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'page_info_strings.grdp')] = path.join(config.srcDir, 'components', 'page_info_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'password_manager_strings.grdp')] = path.join(config.srcDir, 'components', 'password_manager_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'payments_strings.grdp')] = path.join(config.srcDir, 'components', 'payments_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'pdf_strings.grdp')] = path.join(config.srcDir, 'components', 'pdf_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'policy_strings.grdp')] = path.join(config.srcDir, 'components', 'policy_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'print_media_strings.grdp')] = path.join(config.srcDir, 'components', 'print_media_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'printing_component_strings.grdp')] = path.join(config.srcDir, 'components', 'printing_component_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'reset_password_strings.grdp')] = path.join(config.srcDir, 'components', 'reset_password_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'safe_browsing_strings.grdp')] = path.join(config.srcDir, 'components', 'safe_browsing_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'security_interstitials_strings.grdp')] = path.join(config.srcDir, 'components', 'security_interstitials_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'security_state_strings.grdp')] = path.join(config.srcDir, 'components', 'security_state_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'ssl_errors_strings.grdp')] = path.join(config.srcDir, 'components', 'ssl_errors_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'sync_ui_strings.grdp')] = path.join(config.srcDir, 'components', 'sync_ui_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'translate_strings.grdp')] = path.join(config.srcDir, 'components', 'translate_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'undo_strings.grdp')] = path.join(config.srcDir, 'components', 'undo_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'version_ui_strings.grdp')] = path.join(config.srcDir, 'components', 'version_ui_strings.grdp')
    autoGeneratedBraveToChromiumMapping[path.join(braveAppDir, 'management_strings.grdp')] = path.join(config.srcDir, 'components', 'management_strings.grdp')
